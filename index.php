...
<header id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		<div class="item">
			<div class="fill" style="background-image:url('images/bm.jpg');"></div>
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">ONLINE CLASSROOMS</h2>
		</div>
		<div class="col-md-6">
			<p>The ONLINE CLASSROOMS by <strong>SUNEEL,NARAYAN,RAJKUMAR</strong> includes:</p>
			<ul>
