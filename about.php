        ...
        <div class="col-md-6">
        <h2>ABOUT ONLINE CLASSROOMS</h2>
        <p>The <strong>“Online Classrooms”</strong> Website (web based application) is useful for the
...
In this application, student can attend his\her missed classes from e-learn.</p>
        ...
        <p class="footer text-center">Copyright &copy; Online Classroom 2021  <strong>B.TECH</strong> project Made by <strong>SUNEEL,NARAYAN,RAJKUMAR</strong></p>
